...
def product_links(pro_li):
                ...
                while True:
                    try:
                        ...
                        response = session.get(
                            ...
                            headers=headers,
                            cookies=coo,
                            proxy="http://geonode_SxA5BnHLFX-country-CA:6aaed733-56f0-4ffc-9b44-b7cc64c5ca87@rotating-residential.geonode.com:9004").json()
                        break
                    except:
                        retry -= 1
                        time.sleep(2)
    ...
    df.to_excel("product_links_60630.xlsx", index=False)
...
def product_cat():
    headers = {
        ...
        'accept-language': 'en-US,en;q=0.9',
        'cache-control': 'max-age=0',
        'cookie': 'TealeafAkaSid=MgMjEvN2FU2Vkn6RjDYRXv1GLpwRJ6dP; visitorId=018B4718A59302019EC544D7283F1E05; sapphire=1; mdLogger=false; kampyle_userid=f906-261b-3153-31c9-55c6-6736-9f6d-5ba1; ci_pixmgr=other; _gcl_au=1.1.960206792.1697705207; crl8.fpcuid=74492362-20c1-463a-b7c8-a7b3c8b7ea8f; kampylePageLoadedTimestamp=1698035605479; LAST_INVITATION_VIEW=1698035619800; salsify_session_id=d31b6554-8ad0-47d1-9f83-0636f1974049; GuestLocation=342003|26.270|73.000|RJ|IN; ffsession={%22sessionHash%22:%22156d00c2979a6c1698912089324%22}; egsSessionId=1ce7ac2c-11c3-47a8-963d-b5fdc04d5f50; accessToken=eyJraWQiOiJlYXMyIiwiYWxnIjoiUlMyNTYifQ..eDjwtzKXbH629Y02cTRQ_kbvWOGUXydtHOj0YTR-5UVKWDF7qRQVdQkb2kXEOUr3Ss9LjVC4fbkhnbZv5yyjRHv8h-VGAFHUyLo1Uad-5o0UJKIR5lPWXox2-oF576DHcsEMmwtexiVMfEny5JPr-6DXwlsW0LXaHvITdGbMJVIwJh-wdUwHm7fam5Q-9DTqLQMjrOcL1SLCGSO_3V027RByaVLFOiEUTxWpa0aB6Cwi___4457O5p5_LRkvx7swrUh_tMSH16yqzDGuJvJGCyS5JxJ9gR9qAbB79XitQjI1UNRnxcsh6zcntoE8flJlTI8ViEh3msMo5ON4loA7Dw; idToken=eyJhbGciOiJub25lIn0..; refreshToken=Rk1v1fgr-ToObHXCc_2KFXi_lxycvoisNxsHrQ7pwLQWoflISIOdqhd3exHAB5EKRP3rxWvJvQM_7BEixKyJLw; dteRfWys=s37DK1Ui; kampyleUserSession=1698912090939; kampyleUserSessionsCount=43; kampyleUserPercentile=12.258509233839554; __gads=ID=0e70dc00619d5d00:T=1697704892:RT=1698912092:S=ALNI_MbCWts2qdevbDmidCpzranB7PuKXA; __gpi=UID=00000c6759d3a73e:T=1697704892:RT=1698912092:S=ALNI_MaiO-BZig0n2q9zCkN0YnkwQ8_cJg; UserLocation=60630|41.965761954322524|-87.76362898353945|IL|US; fiatsCookie=DSI_3307|DSN_Chicago%20Wicker%20Park|DSZ_60622; kampyleSessionPageCounter=3; TealeafAkaSid=MgMjEvN2FU2Vkn6RjDYRXv1GLpwRJ6dP; sapphire=1',
    ...
    d = []
    workbook = load_workbook(filename=r"product_links_60630.xlsx")
    worksheet = workbook.active
    ...
    df = pd.DataFrame(d)
    df.to_excel("Target_full_60630.xlsx", index=False)
