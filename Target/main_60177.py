...
def product_links(pro_li):
    ...
    'accept-language': 'en-US,en;q=0.9',
    'cookie': 'visitorId=018A401D855B02019D613E088A10CF27; _gcl_au=1.1.196817580.1693381914; fiatsCookie=DSI_3385|DSN_Times%20Square%2042nd%20Street|DSZ_10036; refreshToken=jDh2FT5pw4DshT5wr_meOC-HkEIoknf54H1k9VbCfAGrXmDXnngoymgaqJGkq6styWTzAq_QDYYLqp4m3vuiXg; crl8.fpcuid=88a4ae08-55f6-4ad3-bbcc-3ac4f2033eee; TealeafAkaSid=3j2gGL_FuBk9U2IOzcWSSwq0rJL6MOTV; sapphire=1; ffsession={%22sessionHash%22:%22170cd9ce8d978c1699944494085%22}; __gads=ID=9fecfe7997034a09:T=1693292970:RT=1699944494:S=ALNI_MaWUGn4H4qmhuS30V8dMjzrfXXcog; __gpi=UID=00000c69bd61bb2a:T=1693292970:RT=1699944494:S=ALNI_MYNKKLE_HMAvhaFHbwTSBdLoE-nzw; brwsr=ca238493-82b9-11ee-83e1-2deb5d6c93aa; UserLocation=60177|41.9913714986604|-88.30961552464795|IL|US; sddStore=DSI_1896|DSN_South%20Elgin|DSZ_60177; _mitata=ZGQ1OTMzY2VjOWJjM2IyM2UyMzFiYzkyNmY4MjA4ZDhjNzkyMTBlNjhiYjYxMzIzMTdjZDU5ZWUyNzdjZGJkNg==_/@#/1699944789_/@#/cWXPYb6QWZ9bCbCM_/@#/NGU0YmFiMzA1NTE2Yjg2YTllZjdhNmQ0OGM1ZWVhMmQ5NWVhNWNlMWQ0YzI2MzdjYzNhYzM1Y2NhMWRlZjJjMA==_/@#/000; _mitata=ZDM0ZmVkNDM2MDBmZWZlZTBkZmQwZjY4ZjdmNGM2NGM2NTQyNTYxOGY4NmJhYTU5MDM0M2M1NWZhOGNiNjhmMA==_/@#/1699942177_/@#/cWXPYb6QWZ9bCbCM_/@#/NmYzN2EyNzJmOGQxNmEyMGRiODIxYjViZWJlMjM0OTM5YTlhMDJjNmY1OGU0Nzg4NmI2MTgzYzgyZWU2MTAxYw==_/@#/000',
    'origin': 'https://www.target.com',
    'referer': 'https://www.target.com/c/frozen-breakfast-food-foods-grocery/-/N-5xsza?Nao=24&moveTo=product-list-grid',
                ...
                while True:
                    try:
                        ...
                        response = session.get(
                            ...
                            headers=headers,
                            cookies=coo,
                            proxy='http://geonode_SxA5BnHLFX-country-IN:6aaed733-56f0-4ffc-9b44-b7cc64c5ca87@rotating-residential.geonode.com:9001').json()
                        break
                    except:
                        retry -= 1
                        time.sleep(2)
    ...
    df.to_excel("product_links_60177.xlsx", index=False)
...
def product_cat():
    ...
    d = []
    workbook = load_workbook(filename=r"product_links_60177.xlsx")
    worksheet = workbook.active
    ...
    # for idx, row in enumerate(worksheet.iter_rows(min_row=2, values_only=True), start=1):
        ...
        if word == "Grocery":
            ...
            data = {
                "zipcode": "60177",
                "store_name": "South Elgin",
                "store_location": "530 S Randall Road, South Elgin, IL",
    ...
    df = pd.DataFrame(d)
    df.to_excel("Target_full_60177.xlsx", index=False)
